...
---@return Worktree[]
function M.worktree_list(icons)
  ...
  for _, worktree in ipairs(worktrees) do
    worktree.display = worktree:to_display_string(max_name_length, max_branch_length + wrapper_length, icons)
  end
...
---@param icons? {worktree: string, branch: string, active: string}
---@return Worktree[]
function M.get_worktrees(icons)
  local worktrees = M.worktree_list(icons)
